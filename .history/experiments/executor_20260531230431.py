...
class ExperimentExecutor:
    ...
    def run(self, config: Dict[str, Any], out_root: str = 'results') -> Dict[str, Any]:
        ...
        framework_version = str(config.get('framework_version') or 'unknown')
        ...
        exp_meta = metadata_mod.ExperimentMetadata(
            ...
            git_commit=metadata_mod.capture_library_versions(['pip']).get('pip'),
            dataset_name=dataset_name,
            dataset_source=dataset_meta.get('dataset_source') or dataset_meta.get('filepath') or dataset_source,
